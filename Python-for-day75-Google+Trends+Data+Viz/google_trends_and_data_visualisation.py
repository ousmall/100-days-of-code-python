...
Original file is located at
    https://colab.research.google.com/drive/1DVRChIOWbTrM7vdNYICNuUPwlD6c_Its
...
max_value_research = df_tesla['TSLA_WEB_SEARCH'].max()
min_value_research = df_tesla['TSLA_WEB_SEARCH'].min()
print(f'Largest value for Tesla in Web Search:{max_value_research} ')
print(f'Smallest value for Tesla in Web Search:{min_value_research} ')

pd.options.display.float_format = '{:,.2f}'.format
df_tesla.describe() # get all kinds of statistics
...
df_btc_search.MONTH = pd.to_datetime(df_btc_search.MONTH).dt.strftime('%Y-%m')
df_tesla.MONTH = pd.to_datetime(df_tesla.MONTH).dt.strftime('%Y-%m')
df_unemployment.MONTH = pd.to_datetime(df_unemployment.MONTH).dt.strftime('%Y-%m')
df_unemployment.head()
...
ax1.plot(df_tesla.MONTH, df_tesla.TSLA_USD_CLOSE, color='b')
ax2.plot(df_tesla.MONTH, df_tesla.TSLA_WEB_SEARCH, color='g')
...
plt.title('Tesla Developing Trend', fontsize=18)

ax1 = plt.gca()
ax2 = ax1.twinx()

ax1.plot(df_tesla.MONTH, df_tesla.TSLA_USD_CLOSE, color='green', linewidth=3)
ax2.plot(df_tesla.MONTH, df_tesla.TSLA_WEB_SEARCH, color='orange', linewidth=3)


ax1.set_ylabel('Tesla Stock Price', color='green', fontsize=14)
...
# we can combine 2 csv data in one chart
ax1.plot(df_btc_price_monthly.index, df_btc_price_monthly.CLOSE,
         color='green', linewidth=3, linestyle='dashed')
ax2.plot(df_btc_price_monthly.index, df_btc_search.BTC_NEWS_SEARCH,
